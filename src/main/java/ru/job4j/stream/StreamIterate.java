...
/**
 * 1.4.2. Stream API 1.4. Создание стрима. Метод Stream.iterate()
 ...
 * Обратите внимание, что увеличение счетчика нельзя писать так i++, потому что i++ эквивалентно i += 1,
 * а это предполагает изменение переменной внутри лямбда, что нельзя делать
