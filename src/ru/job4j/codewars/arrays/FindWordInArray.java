...
public class FindWordInArray {
    public static void main(String[] args) {
        ...
        System.out.println("found the needle at position " + Arrays.asList(haystack).indexOf("needle"));  // Быстрое решение!
        ...
        System.out.println("found the needle at position 3? =" + Arrays.asList(haystack1).indexOf("needle"));   // 3
        System.out.println("found the needle at position 5? =" + Arrays.asList(haystack2).indexOf("needle"));   // 5
        System.out.println("found the needle at position 30? =" + Arrays.asList(haystack3).indexOf("needle"));   //30
    }
}
