...
public class Condition {
    public static void main(String[] args) {
        ...
        String roomT = scanner.next();
        String condT = scanner.next() + scanner.nextLine();
        String mode = scanner.nextLine();
        if (mode.equals("auto")) {
            System.out.println(Integer.parseInt(condT));
        }
        if (mode.equals("fan")) {
            System.out.println(Integer.parseInt(roomT));
        }
        if (mode.equals("freeze")) {
            System.out.println(Math.min(Integer.parseInt(condT), Integer.parseInt(roomT)));
        }
        if (mode.equals("heat")) {
            System.out.println(Math.max(Integer.parseInt(condT), Integer.parseInt(roomT)));
        }
    }
}
